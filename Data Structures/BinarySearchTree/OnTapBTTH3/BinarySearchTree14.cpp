...
// In Ra Mức Có Tổng Khóa Nhỏ Nhất Và Tổng Khóa Tương Ứng.
#include <iostream>
#include <queue>
using namespace std;
...
void MinSumKeyLevel(TREE T)
{
    ...
    cout << "[LEVEL] co tong khoa nho nhat la: " << minLevel << endl;
    cout << "Tong khoa: " << minSum;
}
int main()
{
    TREE T;
