...
{
    // Tại sao bài này lại dễ đến thế?
    // Xử lí đụng độ bằng phương pháp nối kết
    // Tức là một phần tử khi được băm, chắc chắn sẽ nằm tại Index đầu tiên được băm
    // Không cần thăm dò, vì các phần tử tạo thành 1 List tại Index đó
    // Sử dụng tìm kiếm tuyến tính O(N) trên List là xong
